...
/*
 * This original file is part of the Symfony package.
 *
...
namespace Linuxforcomposer\Helper;
 ...
 */
class LinuxForComposerProcess implements \IteratorAggregate
{
    const ERR = 'err';
    const OUT = 'out';
    ...
    protected $options = array('suppress_errors' => true);
    protected $exitcode;
    ...
    protected $ttySupported;

    protected $decorateWindows = false;

    protected $decorateWindowsWithReturnCode = false;

    protected $decorateWindowsWithStdout = false;

    protected $decorateWindowsLegacy = false;

    protected $decorateWindowsLegacyWithReturnCode = false;

    protected $decorateWindowsLegacyWithStdout = false;
    ...
    public function __construct($commandline, $cwd = null, array $env = null, $input = null, $timeout = 60, array $options = null)
    {
        ...
        $this->dockerCommand = (string) $commandline;
    }
    ...
    {
        if (null === $this->ttySupported) {
            $this->ttySupported = (bool) @proc_open('echo 1 >/dev/null', array(array('file', '/dev/tty', 'r'), array('file', '/dev/tty', 'w'), array('file', '/dev/tty', 'w')), $pipes);
        }
     ...
     */
    protected function readPipesForOutput($caller, $blocking = false)
    {
        if ($this->outputDisabled) {
     ...
     * @throws RuntimeException In case of failure
     */
    protected function doSignal($signal, $throwException)
    {
    ...
    protected function prepareWindowsCommandLine($cmd, array &$env)
    {
        $uid = uniqid('', true);
        $varCount = 0;
        $varCache = array();
    ...
    {
        $this->setCommandLine($this->dockerCommand);

        if ($this->decorateWindowsLegacy === true) {
            $this->setCommandLine('start /wait bash -i -c "'
                . $this->dockerCommand
                . '"');
        }

        if ($this->decorateWindows === true) {
            $this->setCommandLine('start /wait PowerShell -Command "'
                . $this->dockerCommand
                . '"');
        }

        if ($this->decorateWindowsLegacyWithReturnCode === true) {
            $this->setCommandLine('start /wait bash -c "'
                . $this->dockerCommand
                . ' ; echo $? > '
                . $this->temp_filename
                . '"');
        ...
        if ($this->decorateWindowsWithReturnCode === true) {
            $this->setCommandLine('start /wait PowerShell -Command "'
                . $this->dockerCommand
        ...
        if ($this->decorateWindowsLegacyWithStdout === true) {
            $this->setCommandLine('start /wait bash -i -c "'
                . $this->dockerCommand
                . ' > '
                . $this->temp_filename
        ...
        if ($this->decorateWindowsWithStdout === true) {
            $this->setCommandLine('start /wait PowerShell -Command "$Env:AppReturnValue =  & '
                . $this->dockerCommand
     ...
     * @return bool
     */
    public function isDecorateWindows()
    {
        return $this->decorateWindows;
    }

    /**
     * @param bool $decorateWindows
     * @return LinuxForComposerProcess
     */
    public function setDecorateWindows($decorateWindows)
    {
        $this->decorateWindows = (bool) $decorateWindows;
        return $this;
    }
     ...
     * @return bool
     */
    public function isDecorateWindowsWithReturnCode()
    {
        return $this->decorateWindowsWithReturnCode;
    }

    /**
     * @param bool $decorateWindowsWithReturnCode
     * @return LinuxForComposerProcess
     */
    public function setDecorateWindowsWithReturnCode($decorateWindowsWithReturnCode, $temp_filename)
    {
        $this->decorateWindowsWithReturnCode = (bool) $decorateWindowsWithReturnCode;
        $this->temp_filename = (string) $temp_filename;
        return $this;
    }
     ...
     * @return bool
     */
    public function isDecorateWindowsWithStdout()
    {
        return $this->decorateWindowsWithStdout;
    }

    /**
     * @param bool $decorateWindowsWithStdout
     * @return LinuxForComposerProcess
     */
    public function setDecorateWindowsWithStdout($decorateWindowsWithStdout, $temp_filename)
    {
        $this->decorateWindowsWithStdout = (bool) $decorateWindowsWithStdout;
        $this->temp_filename = (string) $temp_filename;
        return $this;
    }
     ...
     * @return bool
     */
    public function isDecorateWindowsLegacy()
    {
        return $this->decorateWindowsLegacy;
    }

    /**
     * @param bool $decorateWindowsLegacy
     * @return LinuxForComposerProcess
     */
    public function setDecorateWindowsLegacy($decorateWindowsLegacy)
    {
        $this->decorateWindowsLegacy = (bool) $decorateWindowsLegacy;
        return $this;
    }
     ...
     * @return bool
     */
    public function isDecorateWindowsLegacyWithReturnCode()
    {
        return $this->decorateWindowsLegacyWithReturnCode;
    }

    /**
     * @param bool $decorateWindowsLegacyWithReturnCode
     * @return LinuxForComposerProcess
     */
    public function setDecorateWindowsLegacyWithReturnCode($decorateWindowsLegacyWithReturnCode, $temp_filename)
    {
        $this->decorateWindowsLegacyWithReturnCode = (bool) $decorateWindowsLegacyWithReturnCode;
        $this->temp_filename = (string) $temp_filename;
        return $this;
    }
     ...
     * @return bool
     */
    public function isDecorateWindowsLegacyWithStdout()
    {
        return $this->decorateWindowsLegacyWithStdout;
    }

    /**
     * @param bool $decorateWindowsLegacyWithStdout
     * @return LinuxForComposerProcess
     */
    public function setDecorateWindowsLegacyWithStdout($decorateWindowsLegacyWithStdout, $temp_filename)
    {
        $this->decorateWindowsLegacyWithStdout = (bool) $decorateWindowsLegacyWithStdout;
        $this->temp_filename = (string) $temp_filename;
        return $this;
    }
    ...
    /**
     * @param mixed $dockerCommand
     * @return LinuxForComposerProcess
     */
    public function setDockerCommand($dockerCommand)
    {
        $this->dockerCommand = (string) $dockerCommand;
        return $this;
    }
